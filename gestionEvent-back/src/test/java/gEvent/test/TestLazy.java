...
public class TestLazy {
	...
	//Ne retourne pas de doublons si l'intervenant a plusieurs talents ✔
	...
	//Acces aux talents AVANT le em.close ✔
	//Possible de faire des filtres sur les talents ✔
	//Les intervenants n'ayant pas de talentss ont  return ✔
	...
	//Les intervenants n'ayant pas de prestations sont pas return ✔
	//Ne retourne pas de doublons si l'intervenant a plusieurs prestation ✔
	...
	public static void main(String[] args) {
		...
		List<Intervenant> intervenants = showJoinNoDoublonsIntervenantsSansPrestationNiTalentsAfterCloseNotWorking();
